...
Platform Chika dirancang untuk model bisnis pujasera atau grup UMKM dengan beberapa peran yang memiliki tanggung jawab berbeda.

### 1. Admin Pujasera (`pujasera_admin`)
- **Siapa?**: Pengelola utama atau pemilik grup pujasera.
- **Lingkup**: Seluruh pujasera.
- **Tugas Utama**:
    - Mengelola semua tenant di dalam pujaseranya (menambah, melihat).
    - Mengelola langganan Katalog Digital untuk seluruh grup.
    - Melihat laporan penjualan gabungan dari semua tenant.
    - Mengatur pengaturan tingkat pujasera, seperti mengaktifkan atau menonaktifkan kasir di masing-masing tenant.
- **Analogi**: Manajer Gedung Food Court.

### 2. Kasir Pujasera (`pujasera_cashier`)
- **Siapa?**: Staf yang bertugas di kasir pusat pujasera.
- **Lingkup**: Transaksi terpusat pujasera.
- **Tugas Utama**:
    - Mengoperasikan antarmuka kasir terpusat untuk menerima pembayaran dari berbagai tenant.
    - Peran ini hanya relevan jika pujasera menggunakan model pembayaran terpusat.
- **Batasan**: Tidak bisa mengubah data master seperti tenant atau produk.
- **Analogi**: Kasir pusat di pintu keluar Food Court.

### 3. Admin Tenant (`admin`)
- **Siapa?**: Pemilik atau manajer dari satu toko/tenant individual.
- **Lingkup**: Hanya tokonya sendiri.
- **Tugas Utama**:
    - Mengelola menu produk (menambah, mengubah harga, stok).
    - Melihat laporan penjualan dan analisis hanya untuk tokonya.
    - Mengelola karyawan tokonya sendiri.
    - Mengatur promo loyalitas khusus tokonya.
- **Analogi**: Pemilik masing-masing kios di dalam Food Court.

### 4. Kasir Tenant (`cashier`)
- **Siapa?**: Staf kasir yang bekerja di satu tenant spesifik.
- **Lingkup**: Operasional harian di satu toko.
- **Tugas Utama**:
    - Mengoperasikan aplikasi POS untuk mencatat penjualan di tokonya.
    - Mengelola meja dan pesanan untuk tokonya.
- **Batasan**: Akses sangat terbatas, tidak bisa melihat laporan keuangan atau mengubah data master.
- **Analogi**: Staf yang melayani pelanggan di masing-masing kios.
